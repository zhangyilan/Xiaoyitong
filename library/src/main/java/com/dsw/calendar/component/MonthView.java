...
public abstract class MonthView extends View {
    ...
    public MonthView(Context context, AttributeSet attrs) {
        ...
        setRightDate();
        createTheme();
        baseRowSize = rowSize = theme == null ? 170 : theme.dateHeight();
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        width = widthSize;
        NUM_ROWS = 7; //本来是想根据每月的行数，动态改变控件高度，现在为了使滑动的左右两边效果相同，不适用getMonthRowNumber();
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //绘制上一月份
        drawDate(canvas,leftYear,leftMonth,(indexMonth - 10)* width,0);
        //绘制下一月份
        drawDate(canvas,rightYear,rightMonth,(indexMonth + 10)* width,0);
        //绘制当前月份
        drawDate(canvas,selYear,selMonth,indexMonth * width,10);
    }
