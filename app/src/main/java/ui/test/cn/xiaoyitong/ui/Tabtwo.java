...
public class Tabtwo extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        content.setText(Html.fromHtml("1、进行新生资格审核<p>" +
                "2、领取报到证<p>" +
                "3、找到所在系，出示报到证，提交相关资料（如：团员档案等资料信息）<p>" +
                "4、填写个人资料，分配宿舍<p>" +
                "5、缴纳学费<p>" +
                "6、领取军训服"));
    ...
    public void svtcc(View view) {
        ...
        if (mStartLatlng != null) {
            ...
            intent.putExtra("endX", "30.689477");
            intent.putExtra("endY", "103.817123");
