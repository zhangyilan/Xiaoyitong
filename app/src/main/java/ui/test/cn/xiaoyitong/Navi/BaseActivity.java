...
import ui.test.cn.xiaoyitong.Navi.util.ErrorInfo;
import ui.test.cn.xiaoyitong.Navi.util.TTSController;

/**
 * Created by renba on 2017/4/16.
 */
...
//        mAMapNavi.stopNavi();
    ...
    public void onCalculateRouteFailure(int errorInfo) {
        ...
        Log.i("dm", "错误码详细链接见：http://lbs.amap.com/api/android-navi-sdk/guide_main/tools/errorcode/");
        Log.e("dm", "--------------------------------------------");
